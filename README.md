...
A MycoPunk mod that enhances cooldown mechanics for throwables and wingsuit salvo with fully configurable activation modes.

## Description

Enhanced Cooldowns provides enhanced control over the cooldown mechanics in MycoPunk, giving players better control over when and how their abilities activate. The mod offers multiple activation modes for both throwables (grenades) and wingsuit rocket salvo, allowing you to customize the gameplay experience to your preferences.

**Features:**
- **Throwable Enhancement**: Toggle mode to enable/disable auto-throwing grenades, hold mode for continuous auto-throwing
- **Wingsuit Salvo Enhancement**: Toggle mode to enable/disable auto-firing rocket salvo
- **Visual Options**: Suppress the 3D salvo launcher model to save screen space
- **HUD Suppression**: Reduced screen clutter during auto-firing
